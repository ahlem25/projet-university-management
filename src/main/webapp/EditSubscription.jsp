                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Modifier une inscription</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form action="<%=request.getContextPath()%>/EditSubscription" method="POST">
                                <%@include file="/WEB-INF/views/common/forms/subscriptionForm.jsp"%>
                                <div class="form-group col-sm-12 float-left">
                                    <a class="btn btn-secondary ml-2" href="<%=request.getContextPath()%>/subscriptions.jsp">
